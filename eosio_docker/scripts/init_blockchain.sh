...
echo "=== setup wallet: newswallet ==="
# key for eosio account and export the generated password to a file for unlocking wallet later
cleos wallet create -n newswallet --to-console | tail -1 | sed -e 's/^"//' -e 's/"$//' > news_wallet_password.txt
# Owner key for newswallet wallet
cleos wallet import -n newswallet --private-key 5JpWT4ehouB2FF9aCfdfnZ5AwbQbTtHBAwebRXt94FmjyhXwL4K
# Active key for newswallet wallet
cleos wallet import -n newswallet --private-key 5JD9AGTuTeD5BXZwGQ5AtwBqHK21aHmYnTetHgk1B3pjj7krT8N

# * Replace "newswallet" with your own wallet name when you start your own project

echo "=== deploy dapp smart contract ==="
# create account for newsaccount with above wallet's public keys
cleos create account eosio newsaccount EOS6PUh9rs7eddJNzqgqDx1QrspSHLRxLMcRdwHZZRL4tpbtvia5B EOS8BCgapgYA2L4LJfCzekzeSr3rzgSTUXRXwNi8bNRoz31D14en9

# * Replace "newsaccount" with your own account name when you start your own project
